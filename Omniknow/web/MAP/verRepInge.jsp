        ...
        <div id="wrapper">
		    ...
		    <table>
                        ...
                        request.setCharacterEncoding("UTF-8");
                            ...
                            res = sta.executeQuery("select * from reportes where id_inge='" + ses.getAttribute("ID").toString() + "' and solucion = '' and estado != 'MANTENIMIENTO';");
                            int i = 1;
                            while (res.next()) {
                        ...
                        <tr>
                            ...
                            <td><%=problema%></td>
                            <td><%=estado%></td>
                            <td><a href="problema.jsp?algo=<%=idRep%>" >Ver reporte</a></td>
                        </tr>
                        <%
                        i++;
                            }
